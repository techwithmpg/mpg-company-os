...
- MPG project established.
- Master governance instructions established.
...
| Founder bandwidth | Founder-led decision-making and delivery can become a capacity bottleneck | Capacity gate, explicit WIP limit, and staged growth |
| Public repository confidentiality | Commits and history may expose sensitive operational information | Public-safe policy, ignore rules, review, and approved private storage for confidential data |
| Capability fragmentation | Learning across many subjects may be mistaken for delivery readiness | Capability evidence states and sequential commercial build order |
